...
Public Class mySqlDB
    'MySQL
    Public connString As String = "Server=127.0.0.1;Database=learnonline;Uid=root;Pwd=;"
    ...
    Public Function executeDMLSQL(ByVal sSql As String, sqlCommand As MySqlCommand, ByRef sResult As String) As Integer
        Dim sReturn As String = ""
